      ...
      <div className="max-w-6xl mx-auto px-6 w-full">
        <div className="flex flex-col lg:flex-row items-center gap-16 py-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            {/* Headline — gradient text, var(--primary) to var(--arm1) */}
            <Reveal delayClass="delay-100">
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight mb-6 bg-clip-text text-transparent bg-[linear-gradient(90deg,var(--primary),var(--arm1))]">
                Math you can feel
                <br />
                not just see
              </h1>
            ...
            <Reveal delayClass="delay-200">
              <p className="text-lg leading-relaxed mb-10 max-w-xl mx-auto lg:mx-0 text-[var(--muted)]">
            ...
            <Reveal delayClass="delay-300">
              <div className="flex gap-4 justify-center lg:justify-start flex-wrap">
                <Link
                  href="/demo"
                  className="px-8 py-3.5 rounded-xl font-semibold text-sm no-underline bg-[var(--primary)] text-[var(--bg)] transition-opacity duration-300 ease-premium hover:opacity-85"
                >
                  Try the Demo
                </Link>
                <a
                  ...
                  className="px-8 py-3.5 rounded-xl font-semibold text-sm border no-underline flex items-center gap-2 border-[var(--border)] text-[var(--text)] bg-transparent transition-opacity duration-300 ease-premium hover:opacity-85"
                >
            ...
            {mounted && (
              <Reveal delayClass="delay-200">
                <div className="relative">
                  {/* Glow behind canvas */}
                  <div className="absolute inset-0 rounded-2xl blur-3xl opacity-20 bg-[var(--primary)]" />
                  <div className="relative">
                    <UnitCirclePreview />
                    {/* Mode label below canvas */}
                    <p className="text-center text-xs font-mono mt-3 text-[var(--muted)]">
