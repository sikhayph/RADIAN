// ─────────────────────────────────────────────────────────────────────────────
// components/canvas/RotationMatrix.tsx
// HTML5 Canvas port of Flutter RotationMatrixPainter
...
export default function RotationMatrix({ width = 400, height = 400 }: Props) {
  ...
  useEffect(() => {
    ...
    ctx.fillText('RotationMatrix — M4', width / 2, height / 2)
    // ── End placeholder ────────────────────────────────────────────────────
  }, [width, height])
