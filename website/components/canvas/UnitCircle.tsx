// ─────────────────────────────────────────────────────────────────────────────
// components/canvas/UnitCircle.tsx
// HTML5 Canvas port of Flutter UnitCirclePainter
...
export default function UnitCircle({ width = 400, height = 400 }: Props) {
  ...
  useEffect(() => {
    ...
    ctx.fillText('UnitCircle — M4', width / 2, height / 2)
    // ── End placeholder ────────────────────────────────────────────────────
  }, [width, height])
