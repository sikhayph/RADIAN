...
// HTML5 Canvas port of Flutter VectorDiagramPainter
...
export default function VectorDiagram({ width = 400, height = 400 }: Props) {
  ...
  useEffect(() => {
    ...
    ctx.fillText('VectorDiagram — M4', width / 2, height / 2)
    // ── End placeholder ────────────────────────────────────────────────────
  }, [width, height])
